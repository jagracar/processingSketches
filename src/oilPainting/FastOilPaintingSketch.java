 ...
 */
public class FastOilPaintingSketch extends PApplet {
	...
	private boolean drawStepByStep = true;
	...
	public void draw() {
		...
		if (newTrace) {
			...
			if (averageBrushSize == smallerBrushSize && invalidTracesCounter > maxInvalidTracesForSmallerSize) {
				...
				if (trace.calculateColors(maxColorDiff, similarColor, originalImg, null, bgColor)) {
			...
			if (drawStepByStep) {
				trace.paint(step, visitedPixels, imgWidth, imgHeight, null, false);
				step++;
				...
				trace.paint(visitedPixels, imgWidth, imgHeight, null, false);
				newTrace = true;
			}
	...
	static public void main(String[] args) {
		String[] sketchName = new String[] { FastOilPaintingSketch.class.getName() };
